...
export default function QuestionsForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-2xl mx-auto px-5 min-h-[80vh]">
      ...
      <div className="flex gap-2">
        ...
        <button type="submit" className="px-4 py-2 rounded-none cursor-pointer bg-[#002F25] text-white font-medium">
          Save
        </button>
      </div>
    </form>
